...
Por fim, foram removidos os espaços em excesso, pontuações e o emprego das aspas, pois estes atrapalhavam a contagem de palavras. 

Estes ajustes foram realizados para todas as perguntas, e embora já possam ser considerados como um número razoável de modificações, também foram necessários alguns tratamentos particulares a cada uma das questões.
