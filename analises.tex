...
A partir das análises realizadas anteriormente, foi possível obter uma série de pontos que poderiam ser desenvolvidos de forma a obter uma satisfação ainda maior dos \textit{stakeholders} do projeto, e podem ser vistos na tabela \ref{fig:elementosdedesenvolvimento}, que será usado como base inicial para a definição do elemento a ser desenvolvido. 

\begin{landscape}

\begin{table}[h]
\caption{Elementos de desenvolvimento do programa Ocean}
\centerline{\includegraphics[scale=0.3]{img/teste23}}
\label{fig:elementosdedesenvolvimento}
\caption* {Fonte: Elaborado pelo próprio autor}
\end{table}
