...
Inspiração diz respeito a fomentação do empreendedorismo nos alunos para que eles se sintam impulsionados a participar desse ecossistema \textit{startups} ou até abrir as suas próprias. Portanto são feitos diversos convites aos diretores de diversas \textit{startups}, muitos com origens da própria USP, como \textit{Lean Survey}, 99 Táxis e \textit{Squid}, e estes podem explicar um pouco da sua trajetória e das emoções vividas graças aos seus empreendimentos. 
