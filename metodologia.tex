...
O segundo tipo de curso - cursos intensivos - foram feitos para incentivar ideias a se tornarem empresas, então é voltado para o nicho empreendedor, principalmente com soluções dentro da área de tecnologia, que é de onde vêm toda \textit{expertise} da Samsung. Não é necessário que os grupos já possuam uma empresa e um produto em funcionamento, até porque o programa desses cursos envolve questionar e validar hipóteses a respeito do próprio modelo de negócio da empresa, independente da maturidade da ideia. 

// Procurar fonte que fala de empreendedorismo no Brasil.
