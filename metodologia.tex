...
Será apresentado neste capítulo as bases teóricas dos principais modelos analíticos utilizados na realização deste trabalho, de forma a esclarecer dúvidas quanto a sua utilização no decorrer dos próximos capítulos do presente estudo. Em seguida, é ilustrada a metodologia proposta pelo autor que foi concebida de forma que o desenvolvimento deste trabalho estivesse alinhado com o objetivo inicialmente definido.
...
// --------------------------------------------------------------> CAGAR UMA REGRA PARA A ANALISE SWOT
-------------------------------------------------------------->
